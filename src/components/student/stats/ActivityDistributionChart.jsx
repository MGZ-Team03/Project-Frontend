  ...
  return (
    <section className="bg-white dark:bg-[#1a242f] rounded-xl p-8 border border-[#dbe0e6] dark:border-gray-800 shadow-sm flex flex-col items-center">
      <div className="w-full text-left mb-6">
        <h3 className="font-black text-xl text-[#111418] dark:text-white">학습 활동 분포 (최근 7일)</h3>
        <p className="text-sm text-[#617589] dark:text-gray-400">활동량 기준 · 문장 연습(횟수) vs AI 대화(턴) 비중</p>
      </div>
